...
export default function SideNav() {
  ...
  return (
    <AnimatePresence>
      {isMenuOpen && (
        <motion.aside
          className={`absolute left-0 right-0 z-50 flex-col items-start overflow-y-scroll border border-r border-dashed border-zinc-800 bg-zinc-950 p-4 md:flex lg:flex`}
