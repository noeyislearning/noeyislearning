...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 z-20 w-full p-4 flex flex-col justify-center border-t border-dashed bg-indigo-700">
      ...
      <ul className="w-full flex flex-row space-x-4 flex-wrap items-center justify-center text-base font-medium">
        ...
        <li><Link href={""} target={"_blank"} className="hover:underline hover:underline-offset-4">Leetcode</Link></li>
        <li><Link href={""} target={"_blank"} className="hover:underline hover:underline-offset-4">About</Link></li>
        <li><Link href={""} target={"_blank"} className="hover:underline hover:underline-offset-4">Free E-books</Link></li>
      </ul>
    </footer>
  )
}
