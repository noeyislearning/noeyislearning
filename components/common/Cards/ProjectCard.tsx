        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-row gap-6 justify-between items-baseline">
            <div className="flex gap-2 items-baseline">
              ...
              <div className="font-base text-sm text-gray-400">HAU</div>
            </div>
            <div className="text-sm text-gray-400">Database management system for tracking engineering projects.</div>
          </div>
        </div>
      </div>
    </>
