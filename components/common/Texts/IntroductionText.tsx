  ...
  return (
    <>
      <div className="flex flex-col gap-2">
        <h1 className="mb-4 text-3xl lg:text-4xl font-bold">Hello there,</h1>
        <div className="flex flex-col gap-4 ">
          <h3 className="text-base">
            I&apos;m a software developer with a knack for bringing design and functionality together like a symphony. I&apos;m currently fine-tuning my skills at <span className="text-blue-500">Kooest</span>, loving every minute of creating digital masterpieces.
          </h3>
          <h3 className="text-base">
